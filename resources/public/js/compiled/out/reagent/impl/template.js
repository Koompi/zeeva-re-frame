...
var G__20168 = o;
(G__20168[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__20174 = jsprops;
(G__20174["defaultValue"] = value);

(G__20174["onChange"] = ((function (G__20174,v,value,on_change){
return (function (p1__20173_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__20173_SHARP_);
});})(G__20174,v,value,on_change))
);
...
var vec__20177 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__20177,(0),null);
var id = cljs.core.nth.call(null,vec__20177,(1),null);
var class$ = cljs.core.nth.call(null,vec__20177,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___20181 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___20181 == null)){
} else {
var key_20182 = temp__4661__auto___20181;
(jsprops["key"] = key_20182);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__20183 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__20183["name"] = c);
...
var len__4499__auto___20188 = arguments.length;
var i__4500__auto___20189 = (0);
while(true){
if((i__4500__auto___20189 < len__4499__auto___20188)){
args__4502__auto__.push((arguments[i__4500__auto___20189]));

var G__20190 = (i__4500__auto___20189 + (1));
i__4500__auto___20189 = G__20190;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq20186){
var G__20187 = cljs.core.first.call(null,seq20186);
var seq20186__$1 = cljs.core.next.call(null,seq20186);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20187,seq20186__$1);
});
...
break;
default:
var G__20193 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__20193;
continue;
...
var n__4376__auto___20195 = a.length;
var i_20196 = (0);
while(true){
if((i_20196 < n__4376__auto___20195)){
(a[i_20196] = reagent.impl.template.as_element.call(null,(a[i_20196])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___20198 = a.length;
var i_20199 = (0);
while(true){
if((i_20199 < n__4376__auto___20198)){
var val_20200 = (a[i_20199]);
if(((cljs.core.vector_QMARK_.call(null,val_20200)) && ((reagent.impl.template.key_from_vec.call(null,val_20200) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_20199] = reagent.impl.template.as_element.call(null,val_20200));

var G__20201 = (i_20199 + (1));
i_20199 = G__20201;
continue;
} else {
}
...
var ctx = ({});
var vec__20202 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__20202,(0),null);
var derefed = cljs.core.nth.call(null,vec__20202,(1),null);
...
var G__20205 = (cljs.core.count.call(null,argv) - first_child);
switch (G__20205) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__20205){
...
//# sourceMappingURL=template.js.map?rel=1548321579977
