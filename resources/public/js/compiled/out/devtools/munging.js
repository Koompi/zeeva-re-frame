...
var o32799 = temp__4655__auto__;
var temp__4655__auto____$1 = (o32799["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o32800 = temp__4655__auto____$1;
return (o32800["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__31763__auto__ = f;
return (o__31763__auto__["toString"]).call(o__31763__auto__);
} else {
return "";
}
}catch (e32801){var _ = e32801;
return "";
}});
...
try{var o__31763__auto___32803 = t;
(o__31763__auto___32803["cljs$lang$ctorPrWriter"]).call(o__31763__auto___32803,t,writer);
}catch (e32802){var __32804 = e32802;
}
...
var char_code = (function (){var o__31763__auto__ = (new String(char$));
return (o__31763__auto__["charCodeAt"]).call(o__31763__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__31763__auto__ = String;
return (o__31763__auto__["fromCharCode"]).call(o__31763__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32805 = num_code;
switch (G__32805) {
case (1):
return (185);
...
var o__31763__auto__ = String;
return (o__31763__auto__["fromCharCode"]).call(o__31763__auto__,superscript_code);
});
/**
...
}catch (e32807){var _e__31770__auto__ = e32807;
return false;
}})())){
...
var vec__32808 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__32808,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o32811 = temp__4655__auto__;
var temp__4655__auto____$1 = (o32811["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o32812 = temp__4655__auto____$1;
return (o32812["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___32819 = arguments.length;
var i__4500__auto___32820 = (0);
while(true){
if((i__4500__auto___32820 < len__4499__auto___32819)){
args__4502__auto__.push((arguments[i__4500__auto___32820]));

var G__32821 = (i__4500__auto___32820 + (1));
i__4500__auto___32820 = G__32821;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32815){
var vec__32816 = p__32815;
var ns_detector = cljs.core.nth.call(null,vec__32816,(0),null);
...
var G__32822 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__32823 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__32822;
remaining_tokens = G__32823;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32813){
var G__32814 = cljs.core.first.call(null,seq32813);
var seq32813__$1 = cljs.core.next.call(null,seq32813);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32814,seq32813__$1);
});
...
var vec__32827 = cljs.core.split_with.call(null,(function (p1__32826_SHARP_){
return cljs.core.not_EQ_.call(null,p1__32826_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__32827,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__32827,(1),null);
...
var vec__32830 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__32830,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__32830,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__32833 = cljs.core.rest.call(null,remaining_tokens);
var G__32834 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__32833;
name_tokens = G__32834;
continue;
} else {
...
var vec__32837 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__32837,(0),null);
var arity = cljs.core.nth.call(null,vec__32837,(1),null);
var vec__32840 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__32840,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__32840,(1),null);
var vec__32843 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__32843,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__32843,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__32843,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__32843,(3),null);
...
var vec__32849 = result;
var munged_ns = cljs.core.nth.call(null,vec__32849,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32849,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32849,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32849,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32849,(4),null);
var arity = cljs.core.nth.call(null,vec__32849,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__32853 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__32853,(0),null);
var args = cljs.core.nth.call(null,vec__32853,(1),null);
var vec__32856 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32856,(0),null);
var name = cljs.core.nth.call(null,vec__32856,(1),null);
...
var G__32859 = (arity + (1));
var G__32860 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__32861){
var vec__32862 = p__32861;
var arity = cljs.core.nth.call(null,vec__32862,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__32862,(1),null);
...
return cljs.core.get.call(null,arities,p1__32865_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__32866_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___32873 = arguments.length;
var i__4500__auto___32874 = (0);
while(true){
if((i__4500__auto___32874 < len__4499__auto___32873)){
args__4502__auto__.push((arguments[i__4500__auto___32874]));

var G__32875 = (i__4500__auto___32874 + (1));
i__4500__auto___32874 = G__32875;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32869){
var vec__32870 = p__32869;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32870,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32867){
var G__32868 = cljs.core.first.call(null,seq32867);
var seq32867__$1 = cljs.core.next.call(null,seq32867);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32868,seq32867__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__32878__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32878__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32878__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32878__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32879 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32879,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32879,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32879,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32879,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32879,(4),null);
var arity = cljs.core.nth.call(null,vec__32879,(5),null);
...
var o__31763__auto__ = f;
return (o__31763__auto__["getBasis"]).call(o__31763__auto__);
});
/**
...
}catch (e32883){var _e__31770__auto__ = e32883;
...
var G__32884 = (obj[cljs.core.first.call(null,path)]);
var G__32885 = cljs.core.rest.call(null,path);
obj = G__32884;
path = G__32885;
continue;
} else {
...
return (function (accum,p__32886){
var vec__32887 = p__32886;
var bit = cljs.core.nth.call(null,vec__32887,(0),null);
var protocol = cljs.core.nth.call(null,vec__32887,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32890){
...
var selector = cljs.core.nth.call(null,vec__32891,(2),null);
...
return (function (p__32895){
var vec__32896 = p__32895;
var munged_name = cljs.core.nth.call(null,vec__32896,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32896,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__32896,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__32894_SHARP_){
return (obj[cljs.core.first.call(null,p1__32894_SHARP_)]);
});})(name,sorted_matches,vec__32896,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1548321649388
