...
var o26180 = temp__4655__auto__;
var temp__4655__auto____$1 = (o26180["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o26181 = temp__4655__auto____$1;
return (o26181["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25324__auto__ = f;
return (o__25324__auto__["toString"]).call(o__25324__auto__);
} else {
return "";
}
}catch (e26182){var _ = e26182;
return "";
}});
...
try{var o__25324__auto___26184 = t;
(o__25324__auto___26184["cljs$lang$ctorPrWriter"]).call(o__25324__auto___26184,t,writer);
}catch (e26183){var __26185 = e26183;
}
...
var char_code = (function (){var o__25324__auto__ = (new String(char$));
return (o__25324__auto__["charCodeAt"]).call(o__25324__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25324__auto__ = String;
return (o__25324__auto__["fromCharCode"]).call(o__25324__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26186 = num_code;
switch (G__26186) {
case (1):
return (185);
...
var o__25324__auto__ = String;
return (o__25324__auto__["fromCharCode"]).call(o__25324__auto__,superscript_code);
});
/**
...
}catch (e26188){var _e__25331__auto__ = e26188;
return false;
}})())){
...
var vec__26189 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26189,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o26192 = temp__4655__auto__;
var temp__4655__auto____$1 = (o26192["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o26193 = temp__4655__auto____$1;
return (o26193["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___26200 = arguments.length;
var i__4500__auto___26201 = (0);
while(true){
if((i__4500__auto___26201 < len__4499__auto___26200)){
args__4502__auto__.push((arguments[i__4500__auto___26201]));

var G__26202 = (i__4500__auto___26201 + (1));
i__4500__auto___26201 = G__26202;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26196){
var vec__26197 = p__26196;
var ns_detector = cljs.core.nth.call(null,vec__26197,(0),null);
...
var G__26203 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26204 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26203;
remaining_tokens = G__26204;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26194){
var G__26195 = cljs.core.first.call(null,seq26194);
var seq26194__$1 = cljs.core.next.call(null,seq26194);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26195,seq26194__$1);
});
...
var vec__26208 = cljs.core.split_with.call(null,(function (p1__26207_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26207_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26208,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26208,(1),null);
...
var vec__26211 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26211,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26211,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26214 = cljs.core.rest.call(null,remaining_tokens);
var G__26215 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26214;
name_tokens = G__26215;
continue;
} else {
...
var vec__26218 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26218,(0),null);
var arity = cljs.core.nth.call(null,vec__26218,(1),null);
var vec__26221 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26221,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26221,(1),null);
var vec__26224 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26224,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26224,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26224,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26224,(3),null);
...
var vec__26230 = result;
var munged_ns = cljs.core.nth.call(null,vec__26230,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26230,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26230,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26230,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26230,(4),null);
var arity = cljs.core.nth.call(null,vec__26230,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__26234 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__26234,(0),null);
var args = cljs.core.nth.call(null,vec__26234,(1),null);
var vec__26237 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26237,(0),null);
var name = cljs.core.nth.call(null,vec__26237,(1),null);
...
var G__26240 = (arity + (1));
var G__26241 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26242){
var vec__26243 = p__26242;
var arity = cljs.core.nth.call(null,vec__26243,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26243,(1),null);
...
return cljs.core.get.call(null,arities,p1__26246_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26247_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___26254 = arguments.length;
var i__4500__auto___26255 = (0);
while(true){
if((i__4500__auto___26255 < len__4499__auto___26254)){
args__4502__auto__.push((arguments[i__4500__auto___26255]));

var G__26256 = (i__4500__auto___26255 + (1));
i__4500__auto___26255 = G__26256;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26250){
var vec__26251 = p__26250;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26251,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26248){
var G__26249 = cljs.core.first.call(null,seq26248);
var seq26248__$1 = cljs.core.next.call(null,seq26248);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26249,seq26248__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26259__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26259__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26259__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26259__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26260 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26260,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26260,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26260,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26260,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26260,(4),null);
var arity = cljs.core.nth.call(null,vec__26260,(5),null);
...
var o__25324__auto__ = f;
return (o__25324__auto__["getBasis"]).call(o__25324__auto__);
});
/**
...
}catch (e26264){var _e__25331__auto__ = e26264;
...
var G__26265 = (obj[cljs.core.first.call(null,path)]);
var G__26266 = cljs.core.rest.call(null,path);
obj = G__26265;
path = G__26266;
continue;
} else {
...
return (function (accum,p__26267){
var vec__26268 = p__26267;
var bit = cljs.core.nth.call(null,vec__26268,(0),null);
var protocol = cljs.core.nth.call(null,vec__26268,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26271){
var vec__26272 = p__26271;
var ns = cljs.core.nth.call(null,vec__26272,(0),null);
var name = cljs.core.nth.call(null,vec__26272,(1),null);
var selector = cljs.core.nth.call(null,vec__26272,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__26277,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26277,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26277,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26275_SHARP_){
return (obj[cljs.core.first.call(null,p1__26275_SHARP_)]);
});})(name,sorted_matches,vec__26277,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1548216513560
